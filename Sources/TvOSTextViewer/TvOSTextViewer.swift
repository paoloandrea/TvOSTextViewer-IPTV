...
//
//  Modify by Paolo Rossignoli on 21.10.22.
//
...
public class TvOSTextViewer: UIViewController {
    ...
    //Aggiunta la possibilità di gestire gli attributi del testo che viene mostrato
